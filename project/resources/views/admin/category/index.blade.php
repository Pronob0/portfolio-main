              ...
              <div class="card-body px-lg-5 py-lg-5">
                ...
                @if ($categories->count()>0)
                    <div class="table-responsive">
                      <table class="table align-items-center table-light font-weight-bold">
                        ...
                        <tbody>
                            ...
                            @endif
                              <td><a class="mr-2" href="{{ route('admin.category.edit',$category->slug) }}"><i class="ni ni-scissors" aria-hidden="true"></i></a>   <a href="javascript:;" data-toggle="modal" data-target="#deleteModal" data-href="{{ route('admin.category.delete',$category->id) }}"><i class="ni ni-basket text-danger" aria-hidden="true"></i></a></td>
                        </tbody> 
                          @endforeach
                    ...
                    <div class="card">
                      <div class="card-body">
                        <h2 class="text-center">{{ __('Please add category first!!!') }}</h2>
                      </div>
                    </div>
