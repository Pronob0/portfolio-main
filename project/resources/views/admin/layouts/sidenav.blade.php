          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item ">
                <a class="nav-link "  href="#productmenu" data-toggle="collapse" aria-expanded="false"  >
                  ...
                  <span class="nav-link-text text-light">{{ __('Gigs') }}</i></span>
                </a>
                <div id='productmenu' class="collapse sidebar-submenu ">
                    <a href="{{ route('admin.category') }}" class="list-group-item list-group-item-action bg-info" >
                        <span class="  menu-collapsed ">{{ __('Category') }}</span>
                    </a>

                  <a href="#" class="list-group-item list-group-item-action bg-info">
                      <span class="  menu-collapsed ">{{ __('Gigs') }}</span>
                  </a>
                  <a href="#" class="list-group-item list-group-item-action bg-info">
                      <span class="  menu-collapsed ">{{ __('Popular Tags') }}</span>
                  </a>
              </div>
              </li>
              {{-- Customer Side Menu --}}
